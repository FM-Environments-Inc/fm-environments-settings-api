...
export class EnvironmentResolver {
  ...
  getEnvironment(
    @Args() getEnvironmentArgs: GetEnvironmentArgs,
  ): Promise<Environment> {
  ...
  createEnvironment(
    @Args('createEnvironmentData')
    createEnvironmentData: CreateEnvironmentInput,
  ): Promise<Environment> {
  ...
  @Mutation(() => Environment)
  updateEnvironment(
    @Args('updateEnvironmentData')
    updateEnvironmentData: UpdateEnvironmentInput,
  ): Promise<Environment> {
  ...
  @Mutation(() => Environment)
  deleteEnvironment(
    @Args('deleteEnvironmentData')
    deleteEnvironmentData: DeleteEnvironmentInput,
  ): Promise<Environment> {
